...
for i in range(8):
	Three_in_a_row.append([])

for i in range(8):
	for j in range(3):
		Three_in_a_row[i].append([])

Three_in_a_row[0][0] = 0;
Three_in_a_row[0][1] = 1;
Three_in_a_row[0][2] = 2;

Three_in_a_row[1][0] = 3;
Three_in_a_row[1][1] = 4;
Three_in_a_row[1][2] = 5;

Three_in_a_row[2][0] = 6;
Three_in_a_row[2][1] = 7;
Three_in_a_row[2][2] = 8;

Three_in_a_row[3][0] = 0;
Three_in_a_row[3][1] = 3;
Three_in_a_row[3][2] = 6;

Three_in_a_row[4][0] = 1;
Three_in_a_row[4][1] = 4;
Three_in_a_row[4][2] = 7;

Three_in_a_row[5][0] = 2;
Three_in_a_row[5][1] = 5;
Three_in_a_row[5][2] = 8;

Three_in_a_row[6][0] = 0;
Three_in_a_row[6][1] = 4;
Three_in_a_row[6][2] = 8;

Three_in_a_row[7][0] = 2;
Three_in_a_row[7][1] = 4;
Three_in_a_row[7][2] = 6;
...
for i in range(4):
	for j in range(4):
		Heuristic_Array[i].append([])

Heuristic_Array[0][0] = 0;
Heuristic_Array[0][1] = -10;
Heuristic_Array[0][2] = -100;
Heuristic_Array[0][3] = -1000;

Heuristic_Array[1][0] = 10;
Heuristic_Array[1][1] = 0;
Heuristic_Array[1][2] = 0;
Heuristic_Array[1][3] = 0;

Heuristic_Array[2][0] = 100;
Heuristic_Array[2][0] = 0;
Heuristic_Array[2][0] = 0;
Heuristic_Array[2][0] = 0;

Heuristic_Array[3][0] = 1000;
Heuristic_Array[3][1] = 0;
Heuristic_Array[3][2] = 0;
Heuristic_Array[3][3] = 0;



def evaluatePosition(board, player):
    if player=='X':
	opponent='O'
    else:
	opponent='X'
    piece=''
    players, others, t = 0, i, j;
